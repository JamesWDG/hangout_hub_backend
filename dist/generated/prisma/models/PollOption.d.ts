...
export type GetPollOptionGroupByPayload<T extends PollOptionGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<PollOptionGroupByOutputType, T['by']> & {
...
export type PollOptionWhereInput = {
    ...
    option?: Prisma.StringFilter<"PollOption"> | string;
...
export type PollOptionScalarWhereWithAggregatesInput = {
    ...
    option?: Prisma.StringWithAggregatesFilter<"PollOption"> | string;
...
export type PollOptionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "option" | "pollId" | "createdAt" | "updatedAt", ExtArgs["result"]["pollOption"]>;
...
export interface PollOptionFieldRefs {
    ...
    readonly option: Prisma.FieldRef<"PollOption", 'String'>;
